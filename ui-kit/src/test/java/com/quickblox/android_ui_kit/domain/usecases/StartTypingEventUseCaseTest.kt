...
class StartTypingEventUseCaseTest : BaseTest() {
    @Before
    ...
    fun existDialogId_execute_receivedNoError() = runTest {
        ...
        StartTypingEventUseCase(dialogId).execute()
    }
    ...
    fun dialogIdIsEmpty_execute_receivedError() = runTest {
        ...
        StartTypingEventUseCase("").execute()
    }
    ...
    @Test(expected = DomainException::class)
    @ExperimentalCoroutinesApi
    fun sendStartTypingEventThrowException_execute_receivedError() = runTest {
