...
class PrivateChatScreenSettings private constructor() : ScreenSettings {
    ...
    data class Builder(val context: Context) : ScreenSettingsBuilder<PrivateChatScreenSettings> {
        ...
        fun setMessagesComponent(component: Component): Builder {
            this.messagesComponent = component
            return this
        }
        ...
        override fun build(): PrivateChatScreenSettings {
            val settings = PrivateChatScreenSettings()
