...
class PrivateChatInfoScreenSettings private constructor() : ScreenSettings {
    ...
    data class Builder(val context: Context) : ScreenSettingsBuilder<PrivateChatInfoScreenSettings> {
        ...
        override fun build(): PrivateChatInfoScreenSettings {
            val settings = PrivateChatInfoScreenSettings()
