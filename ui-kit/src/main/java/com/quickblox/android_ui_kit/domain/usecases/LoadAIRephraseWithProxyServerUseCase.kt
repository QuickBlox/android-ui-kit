...
@ExcludeFromCoverage
class LoadAIRephraseWithProxyServerUseCase(
    private val dialogId: String?,
    private val toneEntity: AIRephraseEntity,
) :
    ...
    override suspend fun execute(): AIRephraseEntity? {
        ...
        withContext(Dispatchers.IO) {
            ...
            try {
                resultEntity = aiRepository.rephraseWithProxyServer(toneEntity, token, messagesFromUIKit)
