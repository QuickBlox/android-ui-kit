...
class MessagesEventUseCaseWithDeliveredStatusIntegrationTest : BaseTest() {
    ...
    fun createGroupDialog_sendChatMessageAndSendDelivered_receivedDeliveredMessage() = runBlocking {
        createGroupDialog()
        ...
        sendDeliveredStatusToGroupDialog(sentQBChatMessage, createdDialog!!, opponentChatService!!)
    ...
    private fun sendDeliveredStatusToGroupDialog(
        ...
        qbChatDialog.deliverMessage(message)
    }

    @Test
    @ExperimentalCoroutinesApi
    fun createPrivateDialog_sendChatMessageAndSendDelivered_receivedDeliveredMessage() = runBlocking {
        createPrivateDialog()
        ...
        sendDeliveredStatusToPrivateDialog(sentQBChatMessage, createdDialog!!, opponentChatService!!)
    ...
    private fun sendDeliveredStatusToPrivateDialog(
        message: QBChatMessage,
        groupDialog: DialogEntity,
        chatService: QBChatService
    ) {
